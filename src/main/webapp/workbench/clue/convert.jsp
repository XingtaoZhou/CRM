...
<script type="text/javascript">
	$(function(){
		...
		//为市场活动源搜索按钮绑定单击事件
		$("#search_activity_Btn").click(function (){
		...
		$("#aname").keydown(function (event){
			if (event.keyCode == 13){
				//
				$.ajax({
					url:"Clue/searchActivityByName.do",
					type:"get",
					data:{
						"name":$.trim($("#aname").val())
					},
					...
					success:function (resp){
						...
						$.each(resp,function (i,n){
							html += '<tr>';
							html += '<td><input type="radio" name="dxk" value="'+n.id+'"/></td>';
		...
		//为市场活动源模态窗口中的添加按钮绑定单击事件

		$("#submitBtn").click(function (){
			//获得选定的单选框的活动ID
			var activityId = $("input[name=dxk]:checked").val();
			//获得选定活动的名称
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tran-form" action="Clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);"  style="text-decoration: none;"><span id="search_activity_Btn" class="glyphicon glyphicon-search"></span></a></label>
